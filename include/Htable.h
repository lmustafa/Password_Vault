...
typedef struct HTable
{
	...
	int (*hashFunction)(char *identifier, size_t table); ///< function pointer to a function to hash the data
...
**/
HTable *createTable(size_t size, int (*hashFunction)(char *identifier, size_t table),void (*destroyData)(void *data),void (*printData)(void *toBePrinted));
...
**/
Node *createNode(char *identifier, void *data);
...
**/
void insertData(HTable *hashTable, char *identifier, void *data);
 ...
 **/
void removeData(HTable *hashTable, char *identifier);
 ...
 **/
void *lookupData(HTable *hashTable, char *identifier);
